...
package com.bridge.mycityvibes;
...
import com.bridge.mycityvibes.model.MusicProvider;
import com.bridge.mycityvibes.playback.CastPlayback;
import com.bridge.mycityvibes.playback.LocalPlayback;
import com.bridge.mycityvibes.playback.Playback;
import com.bridge.mycityvibes.playback.PlaybackManager;
import com.bridge.mycityvibes.playback.QueueManager;
import com.bridge.mycityvibes.ui.NowPlayingActivity;
import com.bridge.mycityvibes.utils.CarHelper;
import com.bridge.mycityvibes.utils.LogHelper;
import com.bridge.mycityvibes.utils.TvHelper;
import com.bridge.mycityvibes.utils.WearHelper;
...
import static com.bridge.mycityvibes.utils.MediaIDHelper.MEDIA_ID_ROOT;
...
public class MusicService extends MediaBrowserServiceCompat implements
    ...
    public static final String EXTRA_CONNECTED_CAST = "com.bridge.mycityvibes.CAST_NAME";
    // The action of the incoming Intent indicating that it contains a command
    // to be executed (see {@link #onStartCommand})
    public static final String ACTION_CMD = "com.bridge.mycityvibes.ACTION_CMD";
    ...
    public void onCreate() {
        super.onCreate();
        LogHelper.d(TAG, "maaaaaliiiiiiii");
    ...
    public void onLoadChildren(@NonNull final String parentMediaId,
        ...
        if (false) {
            ...
            result.detach();
			mMusicProvider.getChildren(parentMediaId, getResources(), new MusicProvider.Callback() {
				@Override
