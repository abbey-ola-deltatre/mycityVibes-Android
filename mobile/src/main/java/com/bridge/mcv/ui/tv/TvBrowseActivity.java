...
public class TvBrowseActivity extends FragmentActivity
    ...
    public static final String SAVED_MEDIA_ID="com.bridge.mcv.MEDIA_ID";
    public static final String BROWSE_TITLE = "com.bridge.mcv.BROWSE_TITLE";
