...
public class TinyDB {
    ...
    public ArrayList<MediaMetadataCompat> getListObject(String key, Class<?> mClass){
    	Gson gson = new Gson();

    	ArrayList<String> objStrings = getListString(key);
    	ArrayList<MediaMetadataCompat> objects =  new ArrayList<MediaMetadataCompat>();

//    	for(String jObjString : objStrings){
//
//    		Object value  = gson.fromJson(jObjString,  mClass);
//			LogHelper.w("ibile", "mumu", value);
//    		objects.add(value);
//    	}
    	return objects;
    }
    ...
    public void putListObject(String key, ArrayList<MediaMetadataCompat> objArray){
    	checkForNullKey(key);
    	Gson gson = new Gson();
