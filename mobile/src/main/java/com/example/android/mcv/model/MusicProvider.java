...
package com.example.android.mcv.model;
...
import com.example.android.mcv.R;
import com.example.android.mcv.ui.FullScreenPlayerActivity;
import com.example.android.mcv.utils.LogHelper;
import com.example.android.mcv.utils.MediaIDHelper;
...
import static com.example.android.mcv.utils.MediaIDHelper.MEDIA_ID_MUSICS_BY_GENRE;
import static com.example.android.mcv.utils.MediaIDHelper.MEDIA_ID_OFFLINE;
import static com.example.android.mcv.utils.MediaIDHelper.MEDIA_ID_ROOT;
import static com.example.android.mcv.utils.MediaIDHelper.createMediaID;
...
public class MusicProvider extends ArrayList<MediaMetadataCompat>
{
	...
	private MediaBrowserCompat.MediaItem createBrowsableMediaItemForRoot2(Resources resources) {
		MediaDescriptionCompat description = new MediaDescriptionCompat.Builder()
				.setMediaId(MEDIA_ID_OFFLINE)
				.setTitle(resources.getString(R.string.browse_offline))
				.setSubtitle(resources.getString(R.string.browse_offline_catelog))
				.setIconUri(Uri.parse("www.31stbridge.com/mycityvibes/assets/img/icons.png"))
				.build();
