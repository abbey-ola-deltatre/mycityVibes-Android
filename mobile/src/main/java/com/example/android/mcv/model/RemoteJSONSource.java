...
public class RemoteJSONSource implements MusicProviderSource {
	...
	public static JSONArray jsonTracks;
	public static String path;
    @Override
    public Iterator<MediaMetadataCompat> iterator() {
        try {
            int slashPos = CATALOG_URL.lastIndexOf('/');
            path = CATALOG_URL.substring(0, slashPos + 1);
            JSONObject jsonObj = fetchJSONFromUrl(CATALOG_URL);
            tracks = new ArrayList<>();
            if (jsonObj != null || FullScreenPlayerActivity.offlinejsonTracks != null ) {
				if (jsonObj != null){
					jsonTracks = jsonObj.getJSONArray(JSON_MUSIC);
				}
				else{
    ...
    private MediaMetadataCompat buildFromJSON(JSONObject json, String basePath) throws JSONException {
		LogHelper.d("alaby", "basepath", basePath);
